...
export const criarFuncionarioSchema = z.object({
  ...
  cargo: z.enum(['Gerente', 'Atendente', 'Estoquista', 'Limpeza', 'Groomer', 'Veterinario'], {
    message: 'Cargo inválido. Escolha entre: Gerente, Atendente, Estoquista, Limpeza, Groomer, Veterinario'
  }),
