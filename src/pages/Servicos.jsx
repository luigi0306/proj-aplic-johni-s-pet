...
// funções que mexem no carrinho guardado no navegador
  ...
  return (
    <div style={{ background: '#ECEAE4', minHeight: '100vh', display: 'flex', justifyContent: 'center', fontFamily: "'Nunito', sans-serif" }}>
      <div style={{ width: '100%', maxWidth: 1180, background: '#ECEAE4', position: 'relative' }}>
        ...
        <Reveal>
          <section style={{ margin: '8px 24px 0', borderRadius: 34, overflow: 'hidden', background: 'linear-gradient(135deg,#7FB9E6 0%,#A7CFEE 100%)', padding: '54px 56px', display: 'flex', alignItems: 'center', gap: 40 }}>
            <div style={{ flex: 1 }}>
            ...
            <div style={{ flex: '0 0 330px', height: 300, borderRadius: 26, overflow: 'hidden', border: '6px solid #fff', boxShadow: '0 18px 40px rgba(0,0,0,.18)' }}>
        ...
        {SERVICES.map((s) => (
          <Reveal key={s.id}>
            <section style={{ display: 'flex', alignItems: 'center', gap: 44, padding: '40px 48px', flexDirection: s.reverse ? 'row-reverse' : 'row' }}>
